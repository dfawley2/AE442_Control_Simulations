...
rocket.structure.dryMass = 1-motor.wetMass;%rocket.fin.numFins*rocket.structure.finMass + ...
...
rocket.y0 = [0 0 20 0 0 0 0 0 0 0 0 0 rocket.structure.dryMass+motor.wetMass]';
